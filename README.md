...
this.readAPI('http://www.omdbapi.com/?t=iron+man')
.subscribe((data) => {
console.log(data);
console.log(data['Title']);
this.filmData.title=data['Title'];
this.filmData.description =data['Plot'];
this.filmData.imageUrl=data['Poster'];
});
}
readApi(URL: string) {
...
brouillon film service api
  getFilmList(title:string, type: string) : Observable<Film[] >{
    return this.http.get<Film[]>('http://www.omdbapi.com/?i=tt3896198&apikey=ac68cfd').pipe(
